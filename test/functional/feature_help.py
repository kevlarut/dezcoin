...
"""Verify that starting dezcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start dezcoin with -h for help text")
        ...
        self.log.info("Start dezcoin with -version for version information")
        ...
        self.log.info("Start dezcoind with -fakearg to make sure it does not start")
