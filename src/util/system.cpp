...
const char * const BITCOIN_CONF_FILENAME = "dezcoin.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Dezcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Dezcoin";
#else
    // Unix
    return pathRet / ".dezcoin";
#endif
#endif
}
