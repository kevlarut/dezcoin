# Support for Output Descriptors in Dezcoin Core

Since Dezcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Dezcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Dezcoin Core wallets, a convenience function `combo` is
